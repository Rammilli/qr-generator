...
const FRAMES = [
    ...
    { id: "bottom", type: "label", icon: <path d="M4 2h16a2 2 0 012 2v13H2V4a2 2 0 012-2z M2 17h20v3a2 2 0 01-2 2H4a2 2 0 01-2-2v-3z" fill="currentColor" fillOpacity="0.2" stroke="currentColor" /> },
    { id: "top", type: "label", icon: <path d="M2 7h20v13a2 2 0 01-2 2H4a2 2 0 01-2-2V7z M4 2h16a2 2 0 012 2v3H2V4a2 2 0 012-2z" fill="currentColor" fillOpacity="0.2" stroke="currentColor" /> },
    { id: "bubble", type: "label", icon: <path d="M2 8a6 6 0 0112 0v12a2 2 0 01-2 2H4a2 2 0 01-2-2V8z" fill="currentColor" fillOpacity="0.2" stroke="currentColor" /> },
    { id: "border", type: "no_label", icon: <rect x="2" y="2" width="20" height="20" rx="4" fill="none" stroke="currentColor" strokeWidth="4" /> },
    { id: "shadow", type: "no_label", icon: <rect x="2" y="2" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" filter="drop-shadow(3px 3px 0px currentColor)" /> }
]
